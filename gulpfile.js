...
gulp.task('sass', function() {
    ...
    return gulp.src([
        'src/main/webapp/content/sass/custom.scss'

    ])
        .pipe( sass() )
        .pipe( postcss([ autoprefixer({ browsers: ['last 2 versions'] }) ]) )
        .pipe( gulp.dest( 'src/main/webapp/content/css' ) );
});
...
gulp.task('concatcss', ['sass'], function() {
    ...
    return gulp.src([
        ...
        'src/main/webapp/content/css/custom.css'

    ])
        .pipe( concat( 'all.css' ) )
        .pipe( postcss([ autoprefixer({ browsers: ['last 2 versions'] }) ]) )
        .pipe( gulp.dest( 'src/main/webapp/content/css/concated' ) );
});

gulp.task('cssmin', ['concatcss'], function() {

    return gulp.src([
        'src/main/webapp/content/css/concated/all.css'
    ])
        .pipe( min() )
        .pipe( rename({ suffix: '.min' }) )
        .pipe( gulp.dest( 'src/main/webapp/content/css/minified' ) );
});
...
gulp.task('concatjs', function() {
    ...
    return gulp.src([
        ...
        .pipe( concat( 'all.js' ) )
        .pipe( gulp.dest( 'src/main/webapp/content/frontEndJs' ) );
});
